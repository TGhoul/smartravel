...
<div id="container">
    ...
    <br/>
    <div id="content" style="background-color:#2ca999; margin-top:50px;text-align: center;width:960px;">
...
<input data-id="1" class="btn" type="button" value="购 买"
       style="width:72px;height:25px;background:#3cb0d0;color:white;font-size:14px; font-family:黑体;border:0px solid #ba460c;margin-top:15px;margin-left: 1070px;"/>
<input data-id="2" class="btn" type="button" value="购 买"
       style="width:72px;height:25px;background:#3cb0d0;color:white;font-size:14px; font-family:黑体;border:0px solid #ba460c;margin-top:10px;margin-left: 1070px;"/>
<input data-id="3" class="btn" type="button" value="购 买"
       style="width:72px;height:25px;background:#3cb0d0;color:white;font-size:14px; font-family:黑体;border:0px solid #ba460c;margin-top:32px;margin-left: 1070px;"/>
<input data-id="4" class="btn" type="button" value="购 买"
       style="width:72px;height:25px;background:#3cb0d0;color:white;font-size:14px; font-family:黑体;border:0px solid #ba460c;margin-top:8px;margin-left: 1070px;"/>
...
<div id="foot">
  <img src="images/p8.jpg" width="960" height="70"/>
</div>
